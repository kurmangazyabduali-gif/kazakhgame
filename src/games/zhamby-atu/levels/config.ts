...
export const ZHAMBY_LEVELS: Record<number, ZhambyLevelConfig> = {
  ...
  3: { level: 3, horseSpeed: 150, targetDistance: 1200, targetSize: 1.0, windSpeed: 0, targetMotion: 'NONE', attempts: 5 },
  ...
  7: { level: 7, horseSpeed: 200, targetDistance: 1800, targetSize: 1.0, windSpeed: -100, targetMotion: 'NONE', attempts: 5 },
  ...
  11: { level: 11, horseSpeed: 300, targetDistance: 2000, targetSize: 0.7, windSpeed: 200, targetMotion: 'SWAY', attempts: 5 },
  12: { level: 12, horseSpeed: 400, targetDistance: 2200, targetSize: 0.8, windSpeed: 0, targetMotion: 'NONE', attempts: 5 },
  13: { level: 13, horseSpeed: 250, targetDistance: 1800, targetSize: 0.5, windSpeed: -250, targetMotion: 'NONE', attempts: 5 },
  14: { level: 14, horseSpeed: 350, targetDistance: 2800, targetSize: 0.6, windSpeed: -350, targetMotion: 'SWAY', attempts: 5 },
  15: { level: 15, horseSpeed: 450, targetDistance: 3000, targetSize: 0.4, windSpeed: -500, targetMotion: 'MOVE_Y', attempts: 5 },
}
