...
export function HomeHero() {
  return (
    <section className="relative w-full h-[100dvh] flex items-center justify-center overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-white via-sand to-sand z-0" />
      ...
      <div className="absolute inset-0 shadow-[inset_0_0_150px_rgba(255,255,255,0.8)] pointer-events-none z-10" />
      ...
      <div className="relative z-20 flex flex-col items-center text-center px-4 w-full max-w-5xl mt-12">
        ...
        <motion.h1
          ...
          className="font-display text-7xl md:text-8xl lg:text-[140px] leading-none font-bold text-foreground drop-shadow-[0_10px_30px_rgba(255,255,255,0.8)] tracking-wide mb-6"
        >
        ...
        >
          Т°Р»С‹ РґР°Р»Р°РЅС‹ТЈ РјТ±СЂР°СЃС‹<br />Р¶Р°ТЈР° С„РѕСЂРјР°С‚С‚Р°
        </motion.p>
        ...
        >
          Т°Р›РўРўР«Тљ РћР™Р«РќР”РђР  вЂў Р”УРЎРўТ®Р  вЂў Т°Р›Р« Р”РђР›Рђ
        </motion.div>
      </div>
